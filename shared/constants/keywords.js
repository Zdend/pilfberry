...
export const getTitle = title => `${title ? title : BASE_TITLE} | Pilfberry`;
export const getDescription = description => `${description ? description : ''} ${!description || description.length < 50 ? BASE_DESCRIPTION : ''}`;
export const getKeywords = keywords => `${keywords ? keywords : ''} ${!keywords || keywords.length < 50 ? BASE_KEYWORDS : ''}`;
